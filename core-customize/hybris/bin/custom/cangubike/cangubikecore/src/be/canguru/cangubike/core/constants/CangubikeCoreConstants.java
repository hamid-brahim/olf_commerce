 ...
 */
package be.canguru.cangubike.core.constants;

/**
 * Global class for all CangubikeCore constants. You can add global constants for your extension into this class.
 */
public final class CangubikeCoreConstants extends GeneratedCangubikeCoreConstants
{
	public static final String EXTENSIONNAME = "cangubikecore";


	private CangubikeCoreConstants()
	{
		//empty
	}
