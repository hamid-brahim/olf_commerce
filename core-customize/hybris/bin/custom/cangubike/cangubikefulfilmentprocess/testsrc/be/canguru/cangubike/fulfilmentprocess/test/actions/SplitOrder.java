 ...
 */
package be.canguru.cangubike.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(CangubikeFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(CangubikeFulfilmentProcessConstants.PARENT_PROCESS);
