 ...
 */
package be.canguru.cangubike.fulfilmentprocess.test.jobs;
...
import be.canguru.cangubike.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = CangubikeFulfilmentProcessConstants.ORDER_PROCESS_NAME;
