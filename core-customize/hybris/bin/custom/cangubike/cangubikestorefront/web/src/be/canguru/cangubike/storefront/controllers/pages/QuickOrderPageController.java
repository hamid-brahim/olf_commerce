 ...
 */
package be.canguru.cangubike.storefront.controllers.pages;
...
import be.canguru.cangubike.storefront.controllers.ControllerConstants;
...
public class QuickOrderPageController extends AbstractPageController
{
	...
	public String getQuickOrderPage(final Model model) throws CMSItemNotFoundException 
	{
		...
		model.addAttribute("quickOrderMinRows", Integer.valueOf(Config.getInt("cangubikestorefront.quick.order.rows.min", 3)));
		model.addAttribute("quickOrderMaxRows", Integer.valueOf(Config.getInt("cangubikestorefront.quick.order.rows.max", 25)));
