 ...
 */
package be.canguru.cangubike.test.setup;
...
import be.canguru.cangubike.test.constants.CangubikeTestConstants;
import be.canguru.cangubike.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = CangubikeTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/cangubiketest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/cangubiketest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/cangubiketest/import/cstickets.impex");
			...
			importImpexFile(context, "/cangubiketest/import/csquotes.impex");
		}
	}
}
