...
declare module "sap/ui2/srvc/ODataWrapper" {
  import ODataService from "sap/ui2/srvc/ODataService";

  /**
   * @SINCE 1.19.0
   */
  export default class ODataWrapper {
    /**
