...
export declare class SubListComponent extends ListComponent {
    ...
    readonly listData$: Observable<EntitiesModel<any>>;
    readonly dataStructure$: Observable<TableStructure>;
    static ɵfac: i0.ɵɵFactoryDeclaration<SubListComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<SubListComponent, "cx-org-sub-list", never, { "previous": "previous"; "key": "key"; "showHint": "showHint"; "routerKey": "routerKey"; }, {}, never, ["[actions]", "[main]", "[info]"]>;
}
