...
export declare class UnitAddressDetailsComponent {
    ...
    getCountry(isoCode: any): Observable<Country>;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<UnitAddressDetailsComponent, "cx-org-unit-address-details", never, {}, {}, never, never>;
}
