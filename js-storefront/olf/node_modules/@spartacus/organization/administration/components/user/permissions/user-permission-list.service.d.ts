...
import { B2BUserService, PermissionService, Permission, OrganizationItemStatus } from '@spartacus/organization/administration/core';
...
export declare class UserPermissionListService extends SubListService<Permission> {
    ...
    protected load(pagination: PaginationModel, code: string): Observable<EntitiesModel<B2BUser>>;
    /**
     * @override
